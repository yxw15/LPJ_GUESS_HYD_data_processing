...
write_csv(final_mortality_daily, "lpj_guess/lpj_guess_hyd/lpj_control_drought_mort_kappa_daily_full.csv")
...
write_csv(final_mortality_annual_last, "lpj_guess/lpj_guess_hyd/lpj_control_drought_mort_kappa_annual_full.csv")
