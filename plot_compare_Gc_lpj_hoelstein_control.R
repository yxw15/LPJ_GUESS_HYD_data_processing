...
p1 <- ggplot(data_full, aes(x = date, y = gc_value, group = interaction(Source, species, year(date)))) +
  ...
  facet_wrap(~species, ncol = 2) + # Fixed scales for better comparison
...
ggsave("Figures/Hoelstein/compare_obs_vs_lpj_Gc_full.png", p1, width = 12, height = 8)
...
ggsave("Figures/Hoelstein/compare_obs_vs_lpj_Gc_climate_filtered.png", p2, width = 12, height = 8)
